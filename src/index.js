...
//Contract Address = 0x373D7fD7cff7fCe1561d1111863BFa0D2878244a
...
const material_cone = new THREE.MeshPhongMaterial( {color: 0x1fbeee} );
...
function mintNFT(){
    ...
    let contract = new web3.eth.Contract(abi,"0x373D7fD7cff7fCe1561d1111863BFa0D2878244a");
...
const material_cube = new THREE.MeshPhongMaterial( {color: 0x1fbeee} );
